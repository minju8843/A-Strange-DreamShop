...
public class R_Wait1_5_2 : MonoBehaviour
{
    ...
    IEnumerator WaitSecond_1()//133-속마음
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -9651.881f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 41790.12f);    //(오, 위)
    ...
    IEnumerator WaitSecond_4()//136-1
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -9361.837f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 42080.16f);    //(오, 위)
    ...
    IEnumerator WaitSecond_5()//136-2
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -9147.217f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 42294.78f);    //(오, 위)
    ...
    IEnumerator WaitSecond_8()//139-1
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -8851.746f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 42590.25f);    //(오, 위)
    ...
    IEnumerator WaitSecond_9()//139-2
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -8695.648f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 42746.35f);    //(오, 위)
    ...
    IEnumerator WaitSecond_10()//140
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -8494.951f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 42947.05f);    //(오, 위)
    ...
    IEnumerator WaitSecond_11()//141-1
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -8182.756f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 43259.24f);    //(오, 위)
    ...
    IEnumerator WaitSecond_12()//141-2
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -8026.658f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 43415.34f);    //(오, 위)
    ...
    IEnumerator WaitSecond_15()//144
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -7739.551f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 43702.45f);    //(오, 위)
    ...
    IEnumerator WaitSecond_16()//145-1
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -7453.08f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 43988.92f);    //(오, -위)
    ...
    IEnumerator WaitSecond_17()//145-2
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -7300.924f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 44141.08f);    //(오, 위)
    ...
    IEnumerator WaitSecond_18()//145-3
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -7080.715f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 44361.29f);    //(오, 위)
    ...
    IEnumerator WaitSecond_19()//146하기 전 맨 위로 배치
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -5626.596f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 45815.41f);    //(오, -위)
    }
    ...
    IEnumerator WaitSecond_24()//150
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -5285.961f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 46156.04f);    //(오, -위)
    ...
    IEnumerator WaitSecond_27()//153
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -4990.49f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 46451.51f);    //(오, -위)
    ...
    IEnumerator WaitSecond_28()//154
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -4697.807f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 46744.2f);    //(오, -위)
    ...
    IEnumerator WaitSecond_29()//155
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -4430.203f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 47011.8f);    //(오, -위)
    }
    ...
    IEnumerator WaitSecond_30()//156되기 전에 맨 위로 올리기
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -2957.818f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 48484.18f);    //(오, -위)
    ...
    IEnumerator WaitSecond_39()//164
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -2693.01f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 48748.99f);    //(오, -위)
    ...
    IEnumerator WaitSecond_40()//165
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -2489.525f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 48952.48f);    //(오, -위)
    ...
    IEnumerator WaitSecond_41()//166-1
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -2188.77f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 49253.23f);    //(오, -위)
    ...
    IEnumerator WaitSecond_42()//166-2
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -2029.885f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 49412.12f);    //(오, -위)
    ...
    IEnumerator WaitSecond_43()//167-1
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -1748.352f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 49693.65f);    //(오, -위)
    ...
    IEnumerator WaitSecond_44()//167-2
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -1596.555f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 49845.45f);    //(오, -위)
    ...
    IEnumerator WaitSecond_46()//169-1
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -1309.496f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 50132.5f);    //(오, -위)
    ...
    IEnumerator WaitSecond_47()//169-2
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -1153.398f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 50286.6f);    //(오, -위)
    ...
    IEnumerator WaitSecond_48()//170-1
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -871.8652f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 50570.13f);    //(오, -위)
    ...
    IEnumerator WaitSecond_49()//170-2
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -712.9805f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 50729.02f);    //(오, -위)
    ...
    IEnumerator WaitSecond_50()//171
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -417.5098f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 51024.49f);    //(오, -위)
    ...
    IEnumerator WaitSecond_54()//175-선택지
    {
        ...
        TextContainer1.offsetMax = new Vector2(0, 51442.02f);    //(오, -위)
