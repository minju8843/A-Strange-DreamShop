...
public class Sum_1_1_2 : MonoBehaviour
{
    ...
    IEnumerator WaitSecond_7()//페이드 인&아웃 그리고 이동까지
    {
        ...
        Line_2_Index = 12;
        inside_Line_2[12].gameObject.SetActive(true);
    ...
    IEnumerator WaitSecond_8()
    {
        ...
        Line_2_Index = 5;
        inside_Line_2[5].gameObject.SetActive(true);
    ...
    IEnumerator WaitSecond_9()
    {
        ...
        Line_2_Index = 6;
        inside_Line_2[6].gameObject.SetActive(true);
    ...
    IEnumerator WaitSecond_10()
    {
        ...
        Line_2_Index = 7;
        inside_Line_2[7].gameObject.SetActive(true);
    ...
    IEnumerator WaitSecond_11()
    {
        ...
        Line_2_Index = 8;
        inside_Line_2[8].gameObject.SetActive(true);
    ...
    IEnumerator WaitSecond_12()
    {
        ...
        Line_2_Index = 9;
        inside_Line_2[9].gameObject.SetActive(true);
    ...
    IEnumerator WaitSecond_13()
    {
        ...
        Line_2_Index = 10;
        inside_Line_2[10].gameObject.SetActive(true);
    ...
    IEnumerator WaitSecond_14()
    {
        ...
        Line_2_Index = 11;
        inside_Line_2[11].gameObject.SetActive(true);
