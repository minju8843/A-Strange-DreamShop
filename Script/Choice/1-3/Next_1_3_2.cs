...
public class Next_1_3_2 : MonoBehaviour
{
    ...
    IEnumerator WaitSecond_1()//속마음
    {
       ...
       /* QuestObject.Line_Index = 21;
        ...
        TextContainer1.offsetMin = new Vector2(0, -4876.409f);//(왼, 아래)
    ...
    IEnumerator WaitSecond_2()//아무것도 없음
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -3419.696f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 21666.46f);    //(오, 위)
    }
    ...
    IEnumerator WaitSecond_6()
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -3291.474f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 21794.69f);    //(오, 위)
    ...
    IEnumerator WaitSecond_7()
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -3060.613f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 22025.55f);    //(오, 위)
    ...
    IEnumerator WaitSecond_8()
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -2865.491f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 22220.67f);    //(오, 위)
    ...
    IEnumerator WaitSecond_9()
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -2556.084f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 22530.08f);    //(오, 위)
    ...
    IEnumerator WaitSecond_10()
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -2263.401f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 22822.76f);    //(오, 위)
    ...
    IEnumerator WaitSecond_13()
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -1543.893f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 23542.27f);    //(오, 위)
    }
    ...
    IEnumerator WaitSecond_14()
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -1255.641f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 23830.52f);    //(오, 위)
    }
    ...
    IEnumerator WaitSecond_15()
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -959.6533f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 24126.51f);    //(오, 위)
    ...
    IEnumerator WaitSecond_16()
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -811.4561f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 24274.7f);    //(오, 위)
    ...
    IEnumerator WaitSecond_17()
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -648.5254f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 24437.63f);    //(오, 위)
    ...
    IEnumerator WaitSecond_18()
    {
        ...
        TextContainer1.offsetMin = new Vector2(0, -423.8154f);//(왼, 아래)
        TextContainer1.offsetMax = new Vector2(0, 24662.34f);    //(오, 위)
    ...
    IEnumerator WaitSecond_19()
    {
        ...
        TextContainer1.offsetMax = new Vector2(0, 25086.24f);    //(오, 위)
